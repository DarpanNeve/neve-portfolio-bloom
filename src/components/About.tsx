...
export const About = () => {
  ...
  useEffect(() => {
    if (isVisible) {
      const targets = { projects: 7, experience: 3, problems: 600, achievements: 5 };
  ...
  const highlights = [
    ...
    },
    {
      ...
      description: 'Built applications serving 100+ beta testers with 30% faster sync times and 45% throughput gains.',
      color: 'text-green-400'
    },
    {
      icon: Users,
      title: 'Leadership & Community',
      description: 'Led GDSC PCCoE as Flutter Head, organizing events with 700+ participants and mentoring developers.',
      color: 'text-purple-400'
    },
    {
      icon: Trophy,
      title: 'Recognition & Impact',
      description: '2nd Runner-up in National Hackathon BLUE-BIT, solving 600+ DSA problems across platforms.',
      color: 'text-cyan-400'
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className={`text-xl text-foreground max-w-3xl mx-auto transition-all duration-1000 delay-200 ${
            ...
            mobile applications, and modern DevOps practices.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className={`space-y-6 transition-all duration-1000 delay-400 ${
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              With expertise spanning multiple programming languages and frameworks, I create 
              scalable solutions that make a real impact. From Flutter mobile apps to 
              full-stack web applications, I bring ideas to life with clean, efficient code.
            </p>
            <p className="text-lg text-muted-foreground leading-relaxed">
              My experience includes leading development teams, architecting cloud-native solutions, 
              and implementing CI/CD pipelines. I'm passionate about mentoring fellow developers 
              and contributing to the tech community through open-source projects and events.
            </p>
            
            {/* Technologies */}
            <div className="space-y-4">
              <h4 className="text-xl font-semibold text-foreground">Technologies I Love</h4>
                ...
                >
                  <CardContent className="p-6">
                    <div className="flex items-start space-x-4">
                      <div className={`p-3 rounded-lg bg-primary/10 ${highlight.color} group-hover:scale-110 transition-transform duration-300`}>
