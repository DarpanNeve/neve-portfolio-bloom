  ...
  const projects = [
    {
      ...
      image:
        "https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=600&h=400&fit=crop", // Add your actual image URL
      codeLink: null, // Add your actual GitHub link
      liveLink:
        "https://play.google.com/store/apps/details?id=com.towardimagination.soilmaster", // Add your actual live demo link
    ...
    },
    {
      ...
      codeLink: null,
      liveLink:
        "https://play.google.com/store/apps/details?id=zarity.care.zarity_mobile", // Set to null if no live demo available
    ...
    },
    {
      ...
      description:
        "Developed and maintained the full-stack website for Vastav Intellect, a government-recognized IP and business consulting firm offering patent, trademark, and startup services.",
      longDescription:
                  ...
                  <div className="flex flex-wrap gap-2 mt-3">
                    {project.codeLink && (
                      <Button
                        variant="outline"
                        size="sm"
                        className="flex items-center gap-2 px-3 py-1.5 text-xs font-medium rounded-full border-2 border-gray-300 hover:border-gray-900 bg-white hover:bg-gray-50 text-gray-700 hover:text-gray-900 transition-all duration-300 hover:scale-105 shadow-sm hover:shadow-md"
                    ...
                    {project.liveLink && (
                      <Button
                        size="sm"
                        className="flex items-center gap-2 px-3 py-1.5 text-xs font-medium rounded-full bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white border-0 transition-all duration-300 hover:scale-105 shadow-sm hover:shadow-md"
                    ...
                    {!project.codeLink && !project.liveLink && (
                      <Badge
                        variant="secondary"
                        className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-full bg-gradient-to-r from-amber-100 to-orange-100 text-amber-800 border-2 border-amber-200 hover:from-amber-200 hover:to-orange-200 transition-all duration-300 shadow-sm"
                      >
                        In Progress
                      </Badge>
                    )}
                    ...
                    <CardHeader>
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center space-x-4">
                          <div
                            className={`p-3 rounded-xl bg-gradient-to-r ${project.color} text-white animate-float`}
                          >
                            {project.icon}
                          </div>
                          <div>
                      ...
                      <div className="aspect-video rounded-lg overflow-hidden border border-primary/20 bg-gradient-to-br from-primary/20 to-purple-500/20">
                        ...
                        >
                          <div className="text-center">
                            <div
                              className={`w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r ${project.color} flex items-center justify-center text-white`}
                            >
                              {project.icon}
                            </div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {project.metrics.map((metric) => (
                            <Badge
                              key={metric}
                              variant="secondary"
                              className="bg-primary/10 border-primary/20 hover:bg-primary/20 transition-colors duration-300"
                            >
                              {metric}
                            </Badge>
                          ))}
